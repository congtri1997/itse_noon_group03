...
<body>
	...
	<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
		...
		<ul class="navbar-nav px-3">
			<li class="nav-item text-nowrap"><a class="nav-link" href="<c:url value="/logout"/>">Sign
					out</a></li>
		</ul>
	</nav>
	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active"
							href="<c:url value="/profile/updateprofile"/>"> <span
								data-feather="home"></span> Update profile <span class="sr-only">(current)</span>
						</a></li>
			...
			<c:url var="post_url" value="/profile/updateprofile" />
			<div class="col-md-10">
				<form:form id="formAddStudent" action="${post_url}" method="post"
					modelAttribute="formUpdateMember">
					<fieldset class="border p-3">
						<legend class="w-auto">Sửa thông tin thành viên</legend>
							...
							<div class="col-10">
								<div class="input-group">
									...
									<form:input id="userName" path="userName"
										...
										aria-describedby="userNameHelpBlock" readonly="true"
										class="form-control" />
								</div>
								<!-- 	<span id="emailHelpBlock" class="form-text text-muted"></span> -->
						...
						<%-- <div class="form-group row">
							<label for="password" class="col-2 col-form-label">Mật
								khẩu</label>
							<div class="col-10">
								<div class="input-group">
									<div class="input-group-prepend">
